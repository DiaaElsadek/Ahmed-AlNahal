import { Briefcase, MapPin, Calendar, ArrowUpRight, Layers, Compass, Globe, CheckCircle2 } from "lucide-react";
...
const skillCategories = [
  ...
  {
    title: "CAD, BIM & Environmental Simulation",
    code: "TOOL-02",
    skills: [
      { name: "AutoCAD (2D & Architectural)", level: "Advanced" },
      { name: "ENVI-met (Microclimate & Thermal)", level: "Proficient" },
  ...
  {
    title: "Visual Communication & Documentation",
    code: "TOOL-04",
    skills: [
  ...
  return (
    <section id="experience" className="py-24 lg:py-32 relative bg-white border-t border-[var(--border)]">
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-16 pb-6 border-b border-[var(--border)]">
          <div>
            <div className="section-number mb-2">
              <span>02 // PROFESSIONAL STUDIO PRACTICE</span>
            </div>
        ...
        {/* Masterplanning Timeline */}
        <div className="space-y-12">
          {roles.map((role, idx) => (
            <div key={idx} className="drafting-card p-6 sm:p-8 lg:p-10 relative">
              {/* Role Header */}
              <div className="flex flex-wrap items-start justify-between gap-4 pb-6 border-b border-[var(--border)]">
                ...
                <div className="flex items-center gap-2 px-3.5 py-1.5 border border-[var(--border)] bg-[#faf7f2] font-mono text-xs text-[var(--foreground)] font-semibold shrink-0">
                ...
                <div className="pt-6 space-y-8">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-[10px] font-mono text-[var(--muted-light)]">
                      0{role.projects.length} PROJECTS
                    </span>
                  </div>
                ...
                <div className="pt-6">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    {role.bullets?.map((bullet, bIdx) => (
                      <div
                        key={bIdx}
                        className="p-4 bg-[#fbf9f5] border border-[var(--border)] flex items-start gap-3"
                      >
        ...
        {/* Section Divider */}
        <div className="divider-architectural my-20" />
        ...
        <div id="skills">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-14 pb-6 border-b border-[var(--border)]">
            <div>
              <div className="section-number mb-2">
                <span>03 // URBAN PLANNING & GIS CAPABILITIES</span>
              </div>
